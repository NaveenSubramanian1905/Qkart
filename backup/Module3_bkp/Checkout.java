...
public class Checkout {
    ...
    public Boolean addNewAddress(String addresString) {
        try {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='address-item not-selected MuiBox-root css-0']/div[1]/p")));
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            List<WebElement> allAddress = driver.findElements(By.xpath("//div[@class='address-item not-selected MuiBox-root css-0']/div[1]/p"));
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            ...
            WebElement warningPopUp = driver.findElement(By.xpath("//div[@class='SnackbarItem-message']"));
            if(warningPopUp.isDisplayed()){
                String expectedMessage = "You do not have enough balance in your wallet for this purchase";
                String actualMessage = warningPopUp.getText();

...
public class QkartSanity {
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        List<String> expectedProductNames = Arrays.asList("YONEX Smash Badminton Racquet");
        status = homePage.verifyCartContents(expectedProductNames);
        logStatus("End TestCase",
                    "Test Case 8: Add Test Case for Multitab Scenario: ",
                    status ? "PASS" : "FAIL");
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        String mainWindowsURL = driver.getCurrentUrl();
        if(!mainWindowsURL.equals("https://crio-qkart-frontend-qa.vercel.app/")){
            logStatus("End TestCase", "Test Case 9: Verify Privacy Policy and Terms of Service: ", "FAIL");
        ...
        mainWindowsURL = driver.getCurrentUrl();
        if(!mainWindowsURL.equals("https://crio-qkart-frontend-qa.vercel.app/")){
            logStatus("End TestCase", "Test Case 9: Verify Privacy Policy and Terms of Service: ", "FAIL");
            takeScreenshot(driver, "Failure","Testcase09");
            return false;
        ...
        WebElement termOfServiceText = driver.findElement(By.xpath("//h2[text()='Terms of Service']"));
        
        if(!termOfServiceText.isDisplayed()){
            logStatus("End TestCase", "Test Case 9: Verify Privacy Policy and Terms of Service: ", "FAIL");
            takeScreenshot(driver, "Failure","Testcase09");
            return false;
        }
        ...
        logStatus("End TestCase",
                    "Test Case 9: Verify Privacy Policy and Terms of Service: ",
                    "PASS");
        takeScreenshot(driver, "StartTestCase","Testcas09");
        driver.close();
        driver.switchTo().window(windows[0]);
        return true;
    }
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase",
                "Test Case 10: Verify Contact Us feature",
                "DONE");
        Home homePage = new Home(driver);
        homePage.navigateToHome();
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver, "StartTestCase","Testcas11");
        ...
        if(ads.size()!=3){
            logStatus("End TestCase", "Test Case 11: Check for advertisements: ", "FAIL");
            takeScreenshot(driver, "Failure","Testcase11");
            return false;
        }
        ...
        for(int i = 1; i <= 2; i++){
            ...
            logStatus("Step TestCase", "Test Case 11: Check for advertisements ", status ? "PASS" : "FAIL");

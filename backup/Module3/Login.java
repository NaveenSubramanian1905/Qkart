...
public class Login {
    ...
    public Boolean PerformLogin(String Username, String Password) throws InterruptedException {
        ...
        fluenWait.pollingEvery(Duration.ofMillis(250));
        fluenWait.withTimeout(Duration.ofSeconds(30));
        fluenWait.until(ExpectedConditions.presenceOfElementLocated(By.id("notistack-snackbar")));
